...
var relu = exports.relu = function relu(x) {
  return 1 / (1 + Math.pow(Math.E, -x));
};
var calcDist = exports.calcDist = function calcDist(x1, x2) {
  return Math.sqrt((x1 - x2) * (x1 - x2));
};
var roundDecimal = exports.roundDecimal = function roundDecimal(n, d) {
  return parseFloat(Math.round(n * 100) / 100).toFixed(d);
};
var mapRange = exports.mapRange = function mapRange(n, x1, y1, x2, y2) {
 ...
 *
 */
var WMA = __webpack_require__(131);
...
var log = exports.log = function log(msg) {
  ...
  var bold = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
...
exports.resetOutput = exports.output = undefined;

var _math = __webpack_require__(90);

var mi = 0;

var output = exports.output = function output(_ref) {
  ...
  results.map(function (o, i) {
    if (i % index === 0) mi++;
    var matchingPercent = (0, _math.roundDecimal)(Math.abs((0, _math.mapRange)(o.score, 0, max, 0, 100) - 100), decimals);
...
var setObject = function setObject(obj, keys) {
  for (var key in keys) {
    obj[key] = keys[key];
  }
};

var resetOutput = exports.resetOutput = function resetOutput() {
  mi = 0;
};
...
exports.calculateResults = exports.calculateItemDistance = exports.resetScore = undefined;
...
var pushScore = function pushScore(i, v) {
  return dists[i].push(v);
};

var calculateScore = function calculateScore(id) {
  return setmax(dists[id].reduce(function (a, b) {
    return a + b;
  }, 0));
};

var setmax = function setmax(score) {
  if (max < score || max === undefined) max = score;
  return score;
};

var compareKeys = function compareKeys(key, m, i, obj) {
  switch (_typeof(i[key])) {
...
var calculateItemDistance = exports.calculateItemDistance = function calculateItemDistance(_ref) {
  var keys = _ref.keys,
      array = _ref.array,
      obj = _ref.obj,
      showOriginal = _ref.showOriginal;

  keys.map(function (_ref2) {
    var key = _ref2.key,
        m = _ref2.m;
...
var calculateResults = exports.calculateResults = function calculateResults(d, a) {
  var results = [];

  var _loop = function _loop(id) {
    var score = calculateScore(id);

    results.push({
      score: score,
      item: a.filter(function (i) {
        return i.id === id;
      })[0]
    });
  };
...
var _score = __webpack_require__(130);

var _output = __webpack_require__(129);
...
var WMA = function () {
  function WMA(obj) {
    ...
    for (var key in obj) {
      this[key] = obj[key];
    }if (this.verbose) (0, _helper.log)('[WMA] - Initialized', null, true);
  }

  _createClass(WMA, [{
    key: 'match',
    value: function match(obj) {

      var dists = (0, _score.calculateItemDistance)({
        obj: obj,
        keys: this.keys,
        array: this.source,
      ...
      var _calculateResults = (0, _score.calculateResults)(dists, this.source),
          results = _calculateResults.results,
          max = _calculateResults.max;

      var oresult = (0, _output.output)({
        max: max,
        results: results,
