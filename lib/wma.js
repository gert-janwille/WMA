  ...
  _createClass(WMA, [{
    ...
    value: function match(obj) {
      ...
      for (var id in this.dists) {
        this.results.push(this._setObject(id));
      }this.results.sort(function (a, b) {
        return a.score - b.score;
      }).map(function (o, i) {
        if (i % _this.output === 0) _this.matchIndex++;
        o['matchIndex'] = _this.matchIndex;
        o['score'] = (0, _Math.mapRange)(o.score, _this._min, _this._max, 0, 100);
        o['matching'] = (0, _Math.roundDecimal)(Math.abs(o.score - 100), _this.decimals) + '%';
      });
    ...
    value: function _mapSource(key, m) {
      ...
      this.source.map(function (i) {
        ...
        var distance = (0, _Math.calcDist)(i[key], _this2.obj[key]) * m;

        _this2.dists[i.id].push(isNaN(distance) ? 0 : distance);
      });
    }
  }, {
    key: '_setObject',
    value: function _setObject(id) {
